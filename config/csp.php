...
use App\Support\Csp\KbeautyPreset;
...
return [
     ...
     */
    'presets' => [
        // Rien en mode bloquant pour l'instant : policy testée uniquement en
        // report-only ci-dessous, le temps d'observer les violations réelles
        // (site en prod live) avant d'activer l'enforcement.
    ],
