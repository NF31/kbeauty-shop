...
return [
    ...
    */
    ...
    'route' => [
        ...
        // Gate derriere la meme permission que les autres dashboards admin
        // (routes/admin.php : admin.health, Pulse) - PRD/ROADMAP = contenu
        // business, jamais expose publiquement (cf. packages-a-installer.txt).
