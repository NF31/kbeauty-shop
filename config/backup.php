...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                ...
                'exclude' => [
                    ...
                    // Secrets en clair (cles Stripe/Resend/R2, identifiants
                    // DB...) : jamais dans une archive non chiffree envoyee
                    // vers un stockage cloud. En cas de restauration, les
                    // variables d'environnement viennent de la plateforme
                    // d'hebergement (Laravel Cloud), pas d'une sauvegarde.
                    base_path('.env'),
        ...
        'destination' => [
            ...
            /*
             * Disque "backups" (config/filesystems.php) : "local" en dev,
             * "s3" (Cloudflare R2, bucket dedie distinct de celui des
             * factures) en prod via BACKUP_DISK=s3 - meme pattern que
             * INVOICES_DISK.
             */
            'disks' => [
                'backups',
