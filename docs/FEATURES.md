...
| 12.10 | Email confirmation de remboursement (client) | Backend | P1 | ⚪ | Dépend de 16.3 (`RefundOrder`). Le client n'est actuellement notifié par aucun canal qu'un remboursement a été effectué sur sa commande. |
