...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'sku' => 'référence',
        'price_cents' => 'prix',
        'compare_at_price_cents' => 'prix barré',
        ...
        'product_line_id' => 'gamme',
        'country_of_origin' => 'pays d\'origine',
        'ingredients_inci' => 'liste INCI',
        'how_to_use' => "mode d'emploi",
        'skin_types' => 'types de peau',
        'billing_address_id' => 'adresse de facturation',
        'shipping_address_id' => 'adresse de livraison',
        'billing_same_as_shipping' => 'facturation identique à la livraison',
