        ...
        <>
            ...
            <div className="flex flex-1 flex-col gap-8 p-4">
                ...
                <Card className="max-w-3xl">
                    <CardHeader>
                        <CardTitle>Axes de variantes</CardTitle>
                        <CardDescription>
                            Les attributs qui distinguent les variantes (ex :
                            contenance, teinte).
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="flex flex-col gap-3">
                            ...
                            {product.options.length === 0 && (
                                <p className="text-sm text-muted-foreground">
                                    Aucun axe de variante (ex : contenance,
                                    teinte).
                                </p>
                            )}
                        </div>
                ...
                <Card className="max-w-3xl">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Les combinaisons vendables du produit (SKU, prix,
                            stock).
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                ...
                <Card className="max-w-3xl">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Les visuels du produit et de ses variantes.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
